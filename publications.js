const rawJournalText = `Ranjita Kumari, S. Lee, P.K. Anand, Jitae Shin, Sound Localization Training and Induced Brain Plasticity: An fMRI Investigation, Special issue for Brain MRI: Current Development and Applications, Diagnostics, June 2025.
Mehwish Awan, Taeg Keun Whangbo, Jitae Shin, Deep learning methods for autonomous driving scene understanding tasks: A review, Expert Systems With Applications, August. 2025
...
Mehwish Awan, Jitae Shin, A Robust Context-Aware Proposal Refinement Method for Weakly Supervised Object Detection, IEEE Access, Vol. 8 , Page(s): 199768 - 199780, Nov. 03, 2020. DOI: 10.1109/ACCESS.2020.3035606
...
Yongwoo Lee, Hyekyoung Hwang,Byung Tae Oh, Jitae Shin , Pedestrian detection using multi-scale squeeze-and-excitation module, Machine Vision and Applications, vol.31, no.06,, Sep. 2020.
...
김우연, 신지태, 오병태, 영역 구분을 통한 다시점 영상의 깊이맵 손상 복구 기법 (Region-Based Error Concealment of Depth Map in Multiview Video), J-KICS (학국통신학회논문지), Dec. 2015.채널 코딩 결합 기법, 통신학회논문지, vol. 40, No.04, Apr. 2015. (Ack: MSIP
...
Abhishek Roy, Jitae Shin, Navrati Saxena, Entropy-based location management in LTE cellular systems, IET Communications, vol. 6, no.2, pp138-146, Jan. 2012. [Ack: NRF]
...
Navrati Saxena, Abhishek Roy, Jitae Shin, Near-Optimal Tracking for Resident's Comfort in Context-aware Heterogenous Smart Environments, Computer Journal, Vol. 52, No.8, pp878-889, Nov. 2009. [Ack: KOSEF]
...
const rawConferenceText = `Minseon Park, Jitae Shin, "SOURCE-FREE CONCEPT BOTTLENECK MODEL ADAPTATION WITH CONFIDENCE-ADAPTIVE CONDITIONAL ENSEMBLE" 2026 IEEE International Conference on Acoustics, Speech, and Signal Processing (ICASSP 2026), May, 6, 2026
Jungwoo Bae, Jitae Shin, "MAGNITUDE DIFFERENCE CONDITIONED ALL-IN-ONE IMAGE RESTORATION" 2026 IEEE International Conference on Acoustics, Speech, and Signal Processing (ICASSP 2026), May, 5, 2026
Seungho Jung, Jitae Shin, "Dual-Manifold Alignment Contrastive Learning for Knee Osteoarthritis Prediction" ICCRD 2026, January, 24, 2026
Gyutae Oh, Jitae Shin, "Routing Prompts Across Layers: A Global Memory Module for Prompt-Based Continual Learning" ICCRD 2026, January, 24, 2026
Hyunmin Kong, Chunsoo Ahn, Jitae Shin, "Gaussian Process Based Causal Discovery for Root Cause Analysis in Multivariate Time Series" ICCRD 2026, January, 24, 2026
Gyutae Oh, Yeokyoung Won, Donghui Lim, Jitae Shin, "Multimodal Fusion Framework Using Contrastive Learning for Exposure Keratopathy" MICCAI Workshop OMIA, September. 27, 2025
Hyunmin Kong, Jitae Shin, "UGFNet: Uncertainty-Guided Graph Neural Network with Frequency-Aware Feature Fusion for Breast Ultrasound Segmentation" MICCAI Workshop ASMUS, September. 27, 2025
Jungwoo Bae, Jitae Shin, "MFG Sampling: Solving Inverse Problems in Multi-Level High-Frequency Guidance via Diffusion Models" MICCAI Workshop AMAI, September. 23, 2025
Seungin Beak, Jitae Shin, "Counterfactual Augmentation for Long-Tailed Multi-Label Chest X-ray Classification" MICCAI Workshop EMA4MICCAI, September. 23, 2025
Gyutae Oh, Jitae Shin, "Multi-Head CNN-Attention Prompt Pools: Strengthening Prompt Combination and Contextual Insight for Domain Adaptation" ITC-CSCC 2025, July. 7, 2025
Kyuhoon Moon, Jitae Shin, "MCPNet-CLL: Cross-Layer Linking Loss for Coherent Multi-Level Concept Reasoning" ITC-CSCC 2025, July. 7, 2025
Seungho Jung, Jitae Shin, "Medical SAM Adapter++: Adaptive Normalization with Domain Interpretation for Better Adaptation" ITC-CSCC 2025, July. 7, 2025
Minseon Park, Jitae Shin, "Efficient Recurrent Optical Flow Refinement Using Mamba and Multi-Scale Loss" ITC-CSCC 2025, July. 7, 2025
Hyunmin Kong, Jitae Shin, "Uncertainty-Aware and objectness-Guided Feature Quantization for Robust Object Detection" ITC-CSCC 2025, July. 7, 2025
Jungwoo Bae, Jitae Shin, "Handling Imbalanced Medical Dataset with Continuous Class Features using Improved Contrastive Learning (Excellent Paper)" ICAIIC 2025, February. 20, 2025
...
김영준,정희윤,황혜경,신지태, "Controllable & Interpretable 혐오 발언 검출기," 한국통신학회 동계종합학술발표회, Feb. 05, 2020. [NRF2020, ITRC2019]
김영준,황혜경,신지태, "Receptive Filed Steam Block을 이용한 실시간 객체검출 기법," 한국통신학회 동계종합학술발표회, Feb. 05, 2020. [NRF2020]
Sang-il Ahn, Toan Duc Bui,Jitae Shin, "Compression and Intensity Module for Brain MRI Segmentation," ISBI 2019, Venice, Italy, Apr. 08, 2019. [NRF 2017, NRF 2018, ITRC 2018]
안상일, 신지태, "Image Captioning 성능 향상을 위한 효율적인 특징 추출 모델 제안," 영상처리 및 이해에 관한 워크샵 (IPIU), Feb. 13, 2019. [NRF 2018, ITRC 2018]
이용우, 신지태, "FPN과 SE-Net을 활용한 보행자 검출 기법," 영상처리 및 이해에 관한 워크샵 (IPIU), Feb. 13, 2019. [NRF 2017, ITRC 2018]
김영준, 한은, 안영상, 신지태, "Avocado : 인공지능 기반 습관 성형 다이어트," 한국통신학회 동계종합학술발표회, Jan. 25, 2019. [NRF 2017, ITRC 2018]
김영준, 한은, 안영상, 신지태, "Avocado : 딥 러닝 기반 다이어트 다이어리 애플리케이션 입력 인터페이스," 한국통신학회 동계종합학술발표회, Jan. 25, 2019. [NRF 2017, ITRC 2018]
김영준, 한은, 안영상, 신지태, "Avocado : 딥 러닝 기반 다이어트 다이어리 애플리케이션 입력 인터페이스," 한국통신학회 동계종합학술발표회, Jan. 25, 2019. [NRF 2017, ITRC 2018]
황혜경, Awan Mehwish, 이용우, 김영준, 신지태, "KOREN 연구망을 활용한 Smart Safety Campus 서비스를 위한 real-time anomaly detection," 한국통신학회 동계종합학술발표회, Jan. 23, 2019. [NRF 2017, KOREN 2018]
Sang-il Ahn, Toan Duc Bui, Hyekyoung Hwang ,Yongwoo Lee, Jitae Shin, "Image Segmentation With Deformable Spatial Pyramid Pooling," ICEIC 2019, Auckland, New Zealand, Jan. 23, 2019. [ITRC 2018, NRF 2017, KOREN 2018]
...
Hyekyoung Hwang, Toan Duc Bui, Sang-il Ahn, Jitae Shin, "Skipped-Hierarchical Feature Pyramid Networks for Nuclei Instance Segmentation," APSIPA 2018, Honolulu, USA, Nov. 14, 2018. [ITRC 2018, NRF2017, NRF2018]
...
Phuc CHAU, Toan Duc BUI, Yongwoo LEE, Jitae SHIN, "Practical Incremental Network Coding for Multimedia Content Delivery," IEEE ICACT, Feb. 11, 2018. [Outstanding Paper Award]
이용우, Toan D. Bui, 신지태, "DNN 기반 SSD 기법을 활용한 다중 스펙트럼 보행자 검출 기법," 영상처리 및 이해에 관한 워크샵 (IPIU), Feb. 08, 2018.
안상일, 유진아, 신지태, "교통사고 감지용 인공신경망을 이용한 소리 분류 모델 적용," 통신학회 학술대회, Jan. 18, 2018.
Phuc Chau, Jitae Shin , "Low-latency Network Coding for Multimedia Content Uploading," 통신학회동계학술대회, Jan. 18, 2018.
...
Phuc Chau, Yongwoo Lee, Jitae Shin, "Efficient IoT Data Collection Exploiting Systematic Network Coding and D2D Communications," 대한전자공학회 학술대회 [IEEK], Busan, Jun. 2017.
...
Toan Duc Bui, Phuc, Chau, Jitae Shin, "Content-Aware RaptorQ," ICOIN , Da Nanierarchical Random Linear Network Coding for Multicast Scalable Video Streaming," APSIPA ASC 2014, Siem Reap, Cambodia, Dec. 09, 2014.
...
김정훈, 박명우, 신지태, "비트율에 따른 무선영상의 주관적 화질평가와 객관적 화질평가의 연관성 분석," 제25회신호처리합동학술대회, 성균관대학교, Korea, Sep. 2012.
...
조태민, 강지택, 신지태, "은닉노드가존재하는무선네트워크상에서 최적의경쟁윈도우분석," 제24회신호처리합동학술대회, 광주과학기술원(GIST), Nov. 2011.
...
윤지선, 이상태, 박진현, 신지태, "Network coding 을사용한무선릴레이시스템에서 Adaptive Modulation과 MIMO 결합기법의성능분석," 통신학회하계학술대회논문집 2011.
윤지선, 이상태, 신지태, "무선릴레이-OFDM 시스템에서의네트워크 코딩과 MIMO 기법의결합Capacity 분석," 통신학회동계학술대회논문집 2011
...
Taeyoung Lee, Jangkeun Jeong, Junghyun Han, Jitae Shin, "Subcarrier Allocation Method for Macro/Femtocell Interference Avoidance in 3GPP LTE System," 2010 한국통신학회하계종합학술발표회, Jun. 2010. (Ack: NRF)
...
const rawPatentText = `무선트래픽 규격화를 위한 인지품질 기반 영상 데이터 품질평가 모델
압축 센싱 기반 경계면을 고려한 깊이맵 압축과 homogenizing 필터
휘도 분포도 및 색차 분포도를 이용한 무기준법 화질 왜곡 추정 방법 및 장치(NO-REFERENCE QUALITY DISTORTION ESTIMATION METHOD AND APPRATUSS USING DISTRIBUTION CHARTS OF LUMINANCE AND CHROMA HISTOGRAM)
중첩 네트워크에서 셀 결정 방법 및 그를 수행하는 시스템(SYSTEM AND METHOD FOR DETERMINING CELL IN OVERLAID NETWORKS ENVIRONMENT)
셀룰러 시스템에서 인접 셀 간 셀 재 선택을 수행하는 방법(METHOD FOR RESELECTING A CELL AMONG NEIGHBOR CELLS IN CELLULAR SYSTEM)
안테나 일체형 알에프 중계기의 전파 트래킹 장치 및 그 방법(THE RADIO TRACKING EQUIPMENT FOR RF REPEATER EMBEDDED ANTENNAS AND METHOD THEREFOR)
ＩＤ 인증을 통한 전력 공급 시스템 및 그 방법 (THE SYSTEM FOR SUPPLYING POWER USING THE IDENTIFICATION AUTHENTICATION AND METHOD THEREFOR)
모바일 알에프아이디 인증을 통한 원격 전력 공급 시스템 및 그 방법(THE SYSTEM FOR REMOTE CONTROLLING POWER SUPPLY USING THE MOBILE RFID AUTHENTICATION AND METHOD THEREFOR)
...
function sortedYears(type) {
  return Object.keys(publicationData[type]).sort((a, b) => {
...
function bindPublicationTabs() {
  ...
  tabs.forEach((tab) => {
    tab.addEventListener("click", () => {
      ...
      renderPublicationType(tab.dataset.type);
    });
  });
}
